...
public class ItemClickSupport {
    ...
    public static ItemClickSupport addTo(@NotNull RecyclerView view, int itemID) {
    ...
    public static ItemClickSupport removeFrom(@NotNull RecyclerView view, int itemID) {
        ItemClickSupport support = (ItemClickSupport) view.getTag(itemID);
        if (support != null) {
            support.detach(view);
        }
    ...
    private void detach(@NotNull RecyclerView view) {
